defmodule GroceryStore.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule GroceryStore.MyChannel do
        use GroceryStoreWeb, :channel
        alias GroceryStore.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :grocery_store,
                        pubsub_server: GroceryStore.PubSub
end
